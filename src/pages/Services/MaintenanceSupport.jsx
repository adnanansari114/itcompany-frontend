...
export default function MaintenanceSupport() {
  ...
  return (
    <>
      <SEO
        title="Reliable Software Maintenance & IT Support Services"
        description="Ensure the longevity and security of your applications with dedicated 24/7 software maintenance, bug fixing, and continuous technical support."
      />
      ...
      <section className="py-10 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-10">How We Work</h2>
