...
export default function StaffAugmentation() {
  ...
  return (
    <>
      <SEO
        title="Expert IT Staff Augmentation & Remote Developer Teams"
        description="Instantly scale your capacity with pre-vetted, dedicated remote developers and engineers through our flexible IT staff augmentation services."
      />
      ...
      <section className="hero-content-web relative h-[50vh] bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center text-center overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2934&auto=format&fit=crop')] bg-cover bg-center opacity-3"></div>

        <div className="relative z-10 max-w-6xl px-6 mt-2">
          <h1 className="text-4xl md:text-4xl mt-2 font-bold text-white mb-3 leading-tight">
      ...
      <section className="py-10 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-gray-900 mb-6">Our Staffing Process</h2>
          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              <div key={i} className="border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                {openFAQ === i && (
                  <div className="px-8 text-gray-700 bg-gray-50">
                    {faq.a}
                  </div>
                )}
              </div>
