...
const teamMembers = [
  {
    ...
    socials: [
      { name: "LinkedIn", url: "https://www.linkedin.com/in/murtazajawadwala?utm_source=share_via&utm_content=profile&utm_medium=member_android" },
      { name: "about.me", url: "https://about.me/murtazajawadwala" }
    ]
  },
  {
    name: "Touhid Rahman",
                ...
                <div className="content-inner-light">
                  ...
                  <div className="social-links-light">
                    {member.socials.map((social, socialIndex) => (
                      <a key={socialIndex} href={social.url} className="social-btn-light">{social.name}</a>
                    ))}
                  </div>
                </div>
              </div>
