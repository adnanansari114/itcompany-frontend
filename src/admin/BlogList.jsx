...
//   return (
//     <>
//       <SEO title="Admin Blogs" description="Manage blogs" canonicalUrl="/admin/blogs" />
//       <div className="admin-job-container">
//         <h2>Manage Blogs</h2>
//         {msg && <p>{msg}</p>}
//         <button onClick={() => navigate("/admin/add-blog")} className="btn">Add New Blog</button>
...
//                 <td>
//                   <button onClick={() => navigate(`/admin/edit-blog/${blog._id}`)} className="btn">Edit</button>
//                   <button onClick={() => deleteBlog(blog._id)} className="btn" style={{ background: "red" }}>Delete</button>
//                 </td>
//               </tr>
//             ))}
//           </tbody>
